...
-- analisistiposanalisisreferencias
...
CREATE TABLE IF NOT EXISTS `usf`.`pacientes` (
  ...
  `nroDocumento` VARCHAR(10) NULL DEFAULT '-----',
  `nombres` VARCHAR(45) NULL DEFAULT NULL,
  `apellidos` VARCHAR(45) NULL DEFAULT NULL,
  `fechaNacimiento` DATE NULL DEFAULT NULL,
  `direccion` VARCHAR(45) NULL DEFAULT '-----',
  `fechaMuerte` DATE NULL DEFAULT NULL,
  `celular` VARCHAR(10) NULL DEFAULT '-----',
  `telefono` VARCHAR(10) NULL DEFAULT '-----',
...
CREATE TABLE IF NOT EXISTS `usf`.`personales` (
  ...
  `nroRegistro` VARCHAR(10) NULL DEFAULT NULL,
  `nombres` VARCHAR(45) NULL DEFAULT NULL,
  `apellidos` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `usf`.`consultas` (
  ...
  INDEX `fk_consultas_niveles1_idx` (`id_nivel` ASC),
  ...
  CONSTRAINT `fk_consultas_preconsultas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_consultas_niveles1`
...
CREATE TABLE IF NOT EXISTS `usf`.`nombresMedicamentos` (
  `id_nombreMedicamento` INT NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `usf`.`auditoriaModulo1`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `usf`.`auditoriaModulo1` (
  `id_auditoriaModulo1` INT NOT NULL AUTO_INCREMENT,
  `idRegistro` INT NOT NULL,
  `datoAnterior` VARCHAR(200) NULL,
  `datoNuevo` VARCHAR(200) NULL,
  `fecha` DATE NULL,
  `hora` VARCHAR(45) NULL,
  `accion` VARCHAR(45) NULL,
  `tabla` VARCHAR(45) NULL,
  `id_personal` INT(11) NOT NULL,
  `idTablaPadre` VARCHAR(45) NULL,
  INDEX `fk_auditoriaModulo1_personales1_idx` (`id_personal` ASC),
  PRIMARY KEY (`id_auditoriaModulo1`),
  CONSTRAINT `fk_auditoriaModulo1_personales1`
    FOREIGN KEY (`id_personal`)
    REFERENCES `usf`.`personales` (`id_personal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `usf`.`parametrosanalisis` (
  ...
  INDEX `fk_parametrosanalisis_tiposanalisis1_idx` (`id_tipoAnalisis` ASC),
  ...
  CONSTRAINT `fk_parametrosAnalisis_unidadesAnalisis1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_parametrosanalisis_tiposanalisis1`
    FOREIGN KEY (`id_tipoAnalisis`)
    REFERENCES `usf`.`tiposanalisis` (`id_tipoAnalisis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `usf`.`medicamentos` (
  ...
  `id_nombreMedicamento` INT NOT NULL,
  `cantidadXunidad` VARCHAR(45) NULL DEFAULT '1',
...
CREATE TABLE IF NOT EXISTS `usf`.`parametrospreconsulta` (
  ...
  `id_unidadAnalisis` INT(11) NOT NULL,
  PRIMARY KEY (`id_parametroPreconsulta`),
  INDEX `fk_parametrospreconsulta_unidadesanalisis1_idx` (`id_unidadAnalisis` ASC),
  CONSTRAINT `fk_parametrospreconsulta_unidadesanalisis1`
    FOREIGN KEY (`id_unidadAnalisis`)
    REFERENCES `usf`.`unidadesanalisis` (`id_unidadAnalisis`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `usf`.`medicamentosDrogas` (
  ...
  PRIMARY KEY (`id_medicamentoDroga`, `id_medicamento`, `id_droga`),
  INDEX `fk_medicamentos_has_drogas_drogas1_idx` (`id_droga` ASC),
  ...
  CONSTRAINT `fk_medicamentos_has_drogas_drogas1`
    ...
    REFERENCES `usf`.`drogas` (`id_droga`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `usf`.`medicamentosTratamientos` (
  `id_medicamentoTratamiento` INT NOT NULL AUTO_INCREMENT,
  ...
  `id_medicamento` INT(11) NOT NULL,
  PRIMARY KEY (`id_medicamentoTratamiento`),
  INDEX `fk_medicamentosConsultas_tratamientos1_idx` (`id_tratamiento` ASC),
  INDEX `fk_medicamentosConsultas_medicamentos1_idx` (`id_medicamento` ASC),
  CONSTRAINT `fk_medicamentosConsultas_tratamientos1`
    FOREIGN KEY (`id_tratamiento`)
    REFERENCES `usf`.`tratamientos` (`id_tratamiento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_medicamentosConsultas_medicamentos1`
    FOREIGN KEY (`id_medicamento`)
    REFERENCES `usf`.`medicamentos` (`id_medicamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
