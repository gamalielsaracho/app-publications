...
-- -----------------------------------------------------
-- Table `usf`.`auditoriaModulo2`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `usf`.`auditoriaModulo2` (
  `datoAnterior` VARCHAR(200) NULL,
  `datoNuevo` VARCHAR(200) NULL,
  `fecha` DATE NULL,
  `accion` VARCHAR(45) NULL,
  ...
  `id_personal` INT(11) NOT NULL,
  `idTablaPadre` VARCHAR(45) NULL,
  INDEX `fk_auditoriaModulo2_personales1_idx` (`id_personal` ASC),
  CONSTRAINT `fk_auditoriaModulo2_personales1`
    FOREIGN KEY (`id_personal`)
    REFERENCES `usf`.`personales` (`id_personal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `usf`.`auditoriaModulo3`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `usf`.`auditoriaModulo3` (
  `datoAnterior` VARCHAR(200) NULL,
  `datoNuevo` VARCHAR(200) NULL,
  `fecha` DATE NULL,
  `accion` VARCHAR(45) NULL,
  ...
  `id_personal` INT(11) NOT NULL,
  `idTablaPadre` VARCHAR(45) NULL,
  INDEX `fk_auditoriaModulo3_personales1_idx` (`id_personal` ASC),
  CONSTRAINT `fk_auditoriaModulo3_personales1`
    FOREIGN KEY (`id_personal`)
    REFERENCES `usf`.`personales` (`id_personal`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
