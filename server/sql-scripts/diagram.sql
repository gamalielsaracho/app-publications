...
-- -----------------------------------------------------
-- Table `usf`.`sintomasConsultas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `usf`.`sintomasConsultas` (
  `id_sintomaConsulta` INT NOT NULL AUTO_INCREMENT,
  `id_sintoma` INT NOT NULL,
  `id_consulta` INT(11) NOT NULL,
  `observaciones` VARCHAR(50) NULL,
  PRIMARY KEY (`id_sintomaConsulta`, `id_sintoma`, `id_consulta`),
...
CREATE TABLE IF NOT EXISTS `usf`.`lotesmedicamentos` (
  ...
  `cantidadVariable` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `usf`.`medicamentos` (
  ...
  `cantidadFarmaceutica` VARCHAR(45) NOT NULL DEFAULT '1' COMMENT 'un ejemplo -> 30 Id_presentacion , Si son comprimidos.',
