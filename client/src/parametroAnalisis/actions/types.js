...
export const ABRIR_FORMULARIO_EDITAR_PARAMETRO_ANALISIS_EXITO = 'abrir_formulario_editar_parametro_analisis_exito'
export const ABRIR_FORMULARIO_EDITAR_PARAMETRO_ANALISIS_FALLO = 'abrir_formulario_editar_parametro_analisis_fallo'

	export const EDITAR_PARAMETRO_ANALISIS_REQUEST = 'edit_parametro_analisis_request'
	export const EDITAR_PARAMETRO_ANALISIS_EXITO = 'edit_parametro_analisis_exito'
	export const EDITAR_PARAMETRO_ANALISIS_FALLO = 'edit_parametro_analisis_fallo'

// CREATE.
export const ABRIR_FORMULARIO_CREAR_PARAMETRO_ANALISIS = 'abrir_formulario_crear_parametro_analisis'

	export const CREAR_PARAMETRO_ANALISIS_REQUEST = 'crear_parametro_analisis_request'
	export const CREAR_PARAMETRO_ANALISIS_EXITO = 'crear_parametro_analisis_exito'
	export const CREAR_PARAMETRO_ANALISIS_FALLO = 'crear_parametro_analisis_fallo'
